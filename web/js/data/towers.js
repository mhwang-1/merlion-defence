...
const TOWER_TYPES = {
  ...
  mata: {
    ...
    levels: [
      ...
      { cost: 280, damage: 160, range: 240, fireRate: 0.50, label: 'STAR Overwatch' },
    ],
    ults: [
      { cost: 400, damage: 340, range: 275, fireRate: 0.38, label: 'Anti-Materiel Post', sprite: 't_mata_ua',
        blurb: 'One shot, one hantu.' },
      { cost: 400, damage: 165, range: 250, fireRate: 0.85, label: 'Twin Marksmen', sprite: 't_mata_ub',
  ...
  wok: {
    ...
    levels: [
      ...
      { cost: 250, damage: 56, range: 125, fireRate: 1.1,  burnDps: 27, label: 'Michelin Hawker' },
    ],
    ults: [
      { cost: 350, damage: 82, range: 135, fireRate: 1.1, burnDps: 60, label: 'Dragon Breath Wok', sprite: 't_wok_ua',
        blurb: 'Infernal wok hei — searing afterburn.' },
      { cost: 350, damage: 96, range: 140, fireRate: 1.15, burnDps: 30, splash: 78, label: 'Chilli Crab Cauldron', sprite: 't_wok_ub',
  ...
  power: {
    ...
    levels: [
      ...
      { cost: 300, damage: 88, range: 155, fireRate: 0.90, chain: 4, label: 'Tesla Array' },
    ],
    ults: [
      { cost: 420, damage: 110, range: 170, fireRate: 0.95, chain: 7, label: 'Monsoon Storm', sprite: 't_power_ua',
        blurb: 'Forked lightning sweeps whole packs.' },
      { cost: 420, damage: 210, range: 165, fireRate: 0.85, chain: 2, label: 'Megawatt Coil', sprite: 't_power_ub',
  ...
  ice: {
    ...
    levels: [
      ...
      { cost: 280, damage: 30, range: 125, fireRate: 0.65, slowFactor: 0.40, label: 'Blizzard Bing' },
    ],
    ults: [
      { cost: 390, damage: 40, range: 140, fireRate: 0.70, slowFactor: 0.22, label: 'Absolute Zero', sprite: 't_ice_ua',
        blurb: 'Deep freeze — spirits barely crawl.' },
      { cost: 390, damage: 85, range: 135, fireRate: 0.75, slowFactor: 0.40, label: 'Hailstorm Bing', sprite: 't_ice_ub',
